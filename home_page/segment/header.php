    <header id="top">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark bg-white fixed-top" id="mainNav">
		<div class="container">
		  <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="img/smk/logo.png" alt="Logo SMK BM" class="w-75"><!--  Light<span>Up</span> --> </a>  
			...
			<div id="demo" class="carousel slide" data-ride="carousel" >
			  ...
			  <div class="carousel-inner">
				...
				<div class="carousel-item">
				  <img src="img/smk/c2.jpg" alt="smk" width="1100" height="500">
				    <div class="container">
